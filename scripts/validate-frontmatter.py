...
SCHEMAS = {
    ...
    "agent": {
        ...
        "allowed": {"name", "description", "tools", "model", "color"},
    },
    "output-style": {
        "required": ["name", "description"],
...
def main():
    ...
    skills_dir = ROOT / "plugins" / "dotclaude" / "skills"
    ...
    # Agents: agents/*.md
    agents_dir = ROOT / "plugins" / "dotclaude" / "agents"
    ...
    styles_dir = ROOT / "plugins" / "dotclaude" / "output-styles"
