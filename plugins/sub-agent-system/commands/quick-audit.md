---
description: Lightweight single-agent security audit for a specific path or module. No full pipeline overhead — ideal for small scopes (1-5 files) or rapid validation. Output goes directly to conversation, no checkpoint required.
---
