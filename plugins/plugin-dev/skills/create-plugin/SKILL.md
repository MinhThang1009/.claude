---
name: create-plugin
description: "This skill should be used when the user asks to create a new Claude Code plugin end-to-end ('create a plugin', 'tao plugin moi', 'scaffold plugin') - guided workflow covering component design, implementation, and validation."
