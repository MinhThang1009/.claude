---
name: configure
description: "This skill should be used when the user asks to enable, disable, or configure hookify rules ('bat/tat rule hookify', 'configure hookify', 'disable rule X'). Interactively toggles .claude/hookify.*.local.md rule files."
