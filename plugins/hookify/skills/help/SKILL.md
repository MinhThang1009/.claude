---
name: help
description: "This skill should be used when the user asks how the hookify plugin works ('hookify la gi', 'how does hookify work', 'help with hookify') or needs an overview of rule files, events, and patterns."
allowed-tools: ["Read"]
---
