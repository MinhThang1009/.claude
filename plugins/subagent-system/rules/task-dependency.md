...
- Pass dependency outputs explicitly in the dependent agent's prompt — subagents start with fresh context and do not see previous results (exception: `CLAUDE_CODE_FORK_SUBAGENT=1` forks inherit full parent context)
...
- Assume a subagent will infer what happened in a prior phase without being told
