...
description: "This skill should be used when the user asks to resume an interrupted pipeline ('resume pipeline', 'tiep tuc pipeline', 'restore from checkpoint'), or when pipeline state was lost after /compact or a session restart. Reads the latest checkpoint and reconstructs pipeline state."
---
