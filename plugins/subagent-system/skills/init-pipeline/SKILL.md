---
name: init-pipeline
description: "This skill should be used when the user asks to set up or initialize the subagent-system pipeline for a project ('init pipeline', 'set up the pipeline', 'khoi tao pipeline'). Creates PIPELINE_CONFIG.md and checkpoint scaffolding."
