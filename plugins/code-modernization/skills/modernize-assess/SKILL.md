...
description: "This skill should be used when the user asks to assess a legacy system for modernization ('modernize assess', 'danh gia he thong legacy') - full discovery and portfolio analysis: inventory, complexity, technical debt, effort estimation."
