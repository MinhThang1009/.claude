---
name: modernize-map
description: "This skill should be used when the user asks to map dependencies and topology of a legacy system ('modernize map', 've dependency graph he thong legacy') - call graphs, data lineage, batch flows rendered as navigable diagrams."
