...
description: "This skill should be used when the user asks for a multi-agent greenfield rebuild of a legacy system ('modernize reimagine', 'rebuild tu specs') - extract specs from legacy, design AI-native, scaffold and validate with human-in-the-loop."
