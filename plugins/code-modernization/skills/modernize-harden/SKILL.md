...
description: "This skill should be used when the user asks for a security vulnerability scan with a reviewable remediation patch on legacy code ('modernize harden', 'security scan legacy') - OWASP, CWE, CVE, secrets, injection."
