...
description: "This skill should be used when the user asks to review a GitHub pull request AND post the findings as a comment on the PR ('review and comment on PR', 'review PR roi comment len do'). Multi-agent confidence scoring, threshold 80/100, posts via gh. For local working-tree review without posting, use the code-review skill."
