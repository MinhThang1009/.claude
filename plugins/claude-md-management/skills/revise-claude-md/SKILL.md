...
description: "This skill should be used when the user asks to update CLAUDE.md with learnings from the current session ('revise CLAUDE.md', 'update CLAUDE.md voi nhung gi vua hoc', 'save session learnings to project memory')."
