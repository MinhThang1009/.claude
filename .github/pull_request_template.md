...
- [ ] Đã chạy `bash plugins/dotclaude/hooks/test-bash-guard.sh` local, 119/119 PASS
...
- [ ] Update [REFERENCE.md](../docs/REFERENCE.md) / [CLAUDE.md](../MIGRATION-CLAUDE.md) nếu thêm slash command / env var / hook event mới
