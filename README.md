...
A: REFERENCE.md = ~1357 dòng, ~21k tokens. Nếu auto-load thì hết ~10% context window Sonnet 200k (hoặc ~2% Opus 1M) mỗi session. REFERENCE để **NGƯỜI** tra cứu (mở trên màn hình thứ 2 / web), KHÔNG để Claude đọc.
