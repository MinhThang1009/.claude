...
A: REFERENCE.md = ~1100 dòng, ~17k tokens. Nếu auto-load thì hết ~8.5% context window Sonnet 200k (hoặc ~1.7% Opus 1M) mỗi session. REFERENCE để **NGƯỜI** tra cứu (mở trên màn hình thứ 2 / web), KHÔNG để Claude đọc.
